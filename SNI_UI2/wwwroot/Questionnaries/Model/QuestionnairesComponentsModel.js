...
class Cat_Tipo_Preguntas_ModelComponent extends EntityClass {
   ...
   /**@type {ModelProperty}*/ created_at = { type: 'date' };
   /**@type {ModelProperty}*/ updated_at = { type: 'date' };
   /**@type {ModelProperty}*/ editable = { type: '' };
   /**@type {ModelProperty}*/ descripcion_general = { type: 'text' };
   /**@type {ModelProperty}*/ Cat_Valor_Preguntas = { type: 'MasterDetail',  ModelObject: ()=> new Cat_Valor_Preguntas()};
   /**@type {ModelProperty}*/ Pregunta_Tests = { type: 'MasterDetail',  ModelObject: ()=> new Pregunta_Tests()};
}
...
class Cat_Valor_Preguntas_ModelComponent extends EntityClass {
   ...
   /**@type {ModelProperty}*/ created_at = { type: 'date' };
   /**@type {ModelProperty}*/ updated_at = { type: 'date' };
   /**@type {ModelProperty}*/ Resultados_Pregunta_Tests = { type: 'MasterDetail',  ModelObject: ()=> new Resultados_Pregunta_Tests()};
}
...
class Tests_ModelComponent extends EntityClass {
   ...
   /**@type {ModelProperty}*/ image = { type: 'text' };
   /**@type {ModelProperty}*/ Pregunta_Tests = { type: 'MasterDetail',  ModelObject: ()=> new Pregunta_Tests()};
   /**@type {ModelProperty}*/ Resultados_Tests = { type: 'MasterDetail',  ModelObject: ()=> new Resultados_Tests()};
}
